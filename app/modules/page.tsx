      ...
      <section>
        <div className="grid md:grid-cols-2 gap-8">
          {modules.map((module) => (
            <article 
              key={module.slug}
              className="bg-white rounded-lg shadow-md p-6 border-2 border-transparent hover:border-primary-500 transition-all"
            >
              <div className="mb-4">
              ...
              <h3 className="text-2xl font-bold mb-3 text-primary-700">
                {module.title}
              </h3>
              ...
              <div className="mb-6">
                <h4 className="font-semibold text-gray-700 mb-2">主要内容：</h4>
